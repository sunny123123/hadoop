...
//		}
		Job job = new Job();
		job.setJarByClass(Process5.class);
		job.setJobName("Max date");
		
		//FileInputFormat.addInputPath(job, new Path(args[0]));
		//FileOutputFormat.setOutputPath(job, new Path(args[1]));		
		
		//FileInputFormat.addInputPath(job, new Path("hdfs:///mars_tianchi_user_actions.csv"));
		
		MultipleInputs.addInputPath(job,new Path("hdfs:///mars_tianchi_user_actions.csv") , TextInputFormat.class, MyMapper1.class);
		
		MultipleInputs.addInputPath(job,new Path("hdfs:///mars_tianchi_user_actions1.csv") , TextInputFormat.class, MyMapper2.class);
